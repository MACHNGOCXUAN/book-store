...
export const TITLE_REGEX = /^[\p{L}0-9\s\-._:/@&'()[\]{}!?,;:]{1,200}$/u;
...
export const DESCRIPTION_REGEX = /^[\p{L}0-9\s\-.,;:!?()'&]{5,2000}$/u;
...
export const publishDateValidationRules = [
  { required: false, message: "Vui lòng chọn ngày xuất bản!" },
  { type: "object" as const, message: "Ngày xuất bản không hợp lệ!" },
];
