...
const ReviewPage: React.FC = () => {
  ...
  const handleAddToCart = async (book: BookReview) => {
    ...
    try {
      await dispatch(
        addOrUpdateCartItem({ bookId: book.book_id, quantity: 1 })
      ).unwrap();
  ...
  return (
    <div
      style={{ background: "#f5f5f5", minHeight: "100vh", padding: "60px 0" }}
    >
      <div
        className="container"
                    ...
                    >
                      ...
                      <div style={{ marginTop: "auto" }}>
                        <div style={{ marginBottom: 12, textAlign: "left" }}>
                          ...
                          >
                            {(
                              (book.price * (100 - book.discount_percent)) /
                              100
                        ...
                        >
                          ...
                          <Button
                            ...
                            title={
                              book.stock <= 0 ? "Sản phẩm đã hết hàng" : ""
                            }
                            style={{
                              flex: 1,
                              borderRadius: 6,
