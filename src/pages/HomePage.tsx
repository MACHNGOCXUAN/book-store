...
const famousBrands = [
  ...
  { name: 'IPM', logo: 'https://cdn0.fahasa.com/media/wysiwyg/Duy-VHDT/Thuong_hieu_IPM.jpg' },
  { name: 'Nhã Nam', logo: 'https://cdn0.fahasa.com/media/wysiwyg/Duy-VHDT/Thuong_hieu_Nha_Nam.jpg' },
  { name: 'Alphabooks', logo: 'https://cdn0.fahasa.com/media/wysiwyg/Duy-VHDT/Thuong_hieu_AlphaBook.jpg' },
  { name: 'Thái Hà', logo: 'https://cdn0.fahasa.com/media/wysiwyg/Duy-VHDT/Thuong_hieu_Thai_ha.jpg' },
  { name: 'MeBook', logo: 'https://cdn0.fahasa.com/media/wysiwyg/Duy-VHDT/Thuong_hieu_mebook.jpg' },
]
...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="container" style={{ maxWidth: 1200, margin: '0 auto', padding: '0 16px', paddingTop: 20 }}>
          <div
            style={{
              position: 'relative',
              width: '100%',
              ...
              <Col key={index} xs={24} sm={12} md={6}>
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 4px 16px rgba(201,33,39,0.2)'
                  }}
                  onMouseLeave={(e) => {
        ...
        <div className="container" style={{ maxWidth: 1200, margin: '0 auto', padding: '0 16px' }}>
          ...
          <Row gutter={[24, 24]}>
            <Col xs={24} sm={12} lg={6}>
              ...
              >
                <ShoppingOutlined style={{ fontSize: 48, color: '#C92127', marginBottom: 16 }} />
                <Title level={4} style={{ marginBottom: 8 }}>Đa dạng sản phẩm</Title>
                <Paragraph type="secondary">Hàng ngàn đầu sách từ nhiều thể loại khác nhau</Paragraph>
              </Card>
            </Col>
            <Col xs={24} sm={12} lg={6}>
              <Card
                ...
                bodyStyle={{ padding: '32px 24px' }}
              >
                <RocketOutlined style={{ fontSize: 48, color: '#FF6B35', marginBottom: 16 }} />
                <Title level={4} style={{ marginBottom: 8 }}>Giao hàng nhanh</Title>
                <Paragraph type="secondary">Miễn phí ship cho đơn hàng trên 200k</Paragraph>
              </Card>
            </Col>
            <Col xs={24} sm={12} lg={6}>
              <Card
                ...
                bodyStyle={{ padding: '32px 24px' }}
              >
                <SafetyOutlined style={{ fontSize: 48, color: '#F77F00', marginBottom: 16 }} />
                <Title level={4} style={{ marginBottom: 8 }}>Thanh toán an toàn</Title>
                <Paragraph type="secondary">Bảo mật thông tin 100% khi thanh toán</Paragraph>
              </Card>
            </Col>
            <Col xs={24} sm={12} lg={6}>
              <Card
                ...
                bodyStyle={{ padding: '32px 24px' }}
              >
                <CustomerServiceOutlined style={{ fontSize: 48, color: '#06A77D', marginBottom: 16 }} />
                <Title level={4} style={{ marginBottom: 8 }}>Hỗ trợ 24/7</Title>
                <Paragraph type="secondary">Đội ngũ tư vấn nhiệt tình, chuyên nghiệp</Paragraph>
              </Card>
            </Col>
          </Row>
        </div>
              ...
              <Col key={index} xs={12} sm={8} md={6} lg={4}>
                <Card
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 4px 12px rgba(201,33,39,0.15)'
                  }}
                  onMouseLeave={(e) => {
