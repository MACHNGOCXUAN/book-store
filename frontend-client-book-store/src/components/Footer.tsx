      ...
      >
        ...
        <Row gutter={[32, 32]}>
          ...
          <Col xs={24} sm={12} lg={6}>
            <Space direction="vertical" size="middle" style={{ width: "100%" }}>
              <Title
                level={4}
                style={{ color: FOOTER_TEXT_COLOR, marginBottom: 0 }}
              >
                Về chúng tôi
              </Title>
              <Paragraph
              ...
              >
                Cửa hàng sách trực tuyến hàng đầu Việt Nam, mang đến hàng ngàn
                đầu sách chất lượng với giá tốt nhất.
              </Paragraph>
              <Space size="middle">
                <Button
                  type="primary"
            ...
            <Space direction="vertical" size="middle" style={{ width: "100%" }}>
              ...
              <Space direction="vertical" size="small">
                <Space>
                  ...
                  <Text style={{ color: FOOTER_TEXT_SECONDARY }}>
              ...
              <div style={{ marginTop: 16 }}>
                <Text style={{ color: FOOTER_TEXT_SECONDARY, fontSize: 12 }}>
                  Thời gian làm việc:
                </Text>
                <br />
                <Text style={{ color: FOOTER_TEXT_COLOR, fontSize: 13 }}>
                  T2 - T7: 8:00 - 21:00
                </Text>
                <br />
                <Text style={{ color: FOOTER_TEXT_COLOR, fontSize: 13 }}>
        ...
        >
          ...
          <Col xs={24} md={12} style={{ textAlign: "center" }}>
            <Text style={{ color: FOOTER_TEXT_SECONDARY, fontSize: 14 }}>
              Made with{" "}
              <HeartFilled style={{ color: "#ff4d4f", margin: "0 4px" }} /> in
              Vietnam
            </Text>
          </Col>
        </Row>
